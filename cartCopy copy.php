...
//Select Query
$sql= "SELECT idK, size, idB, shoeName, price, image FROM kosik, boty";
...
while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) {
    echo '<div class="product-block" id="product-'.$row['id'].'" data-size="'.$row['size'].'" data-cart-id="'.$row['cart_id'].'">';
