            ...
            <div class="left-section">
                <div class="scrollable-container">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $idKosikFinalDelete[$pocet] = $row['idK'];
                ...
                <div class="scrollable-container">
                    <form action="" method="get">
                        ...
                        <div>
                            ...
                            <h1 class="nadpis">SUMMARY</h1>
                            <div class="cart-summary">
                                
                    <?php
                    echo "<p>SHOE PRICE: " . $priceSummary . " €</p>";
                    ...
                    $priceSummaryShipping = $priceSummary + $shipping;
                    echo "<p class='summary-text'>FINAL PRICE: " . $priceSummaryShipping . " €<p>";
                    ?>
                </div>
